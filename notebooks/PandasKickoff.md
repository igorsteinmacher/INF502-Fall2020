...
```
    ...
    array(['C', 'ruby', 'python', 'haskell', 'javascript', 'C++',
           'coffeescript', 'perl', 'objective-c', 'go', 'java', 'php',
           'erlang', 'scala', 'typescript', 'clojure', 'Perl'], dtype=object)
